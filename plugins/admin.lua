...
local function run(msg,matches)
    ...
    if matches[1] == "markread" then
    	if matches[2] == "on" then
    		...
    		return "پیام های ارسالی به ربات خوانده می شود"
    	end
    ...
    if matches[1] == "contactlist" then
      ...
      return "من لیست مخاطبینم را در دو فایل در پیوی شما ارسال می کنم"
    end
   ...
   return "کاربر  +"..matches[2].." به لیست مخاطبین اضافه شد"
end
 ...
 if matches[1] == "mycontact" and is_sudo(msg) then
    ...
    if matches[1] == "dialoglist" then
      ...
      return "لیست چت ها در دو فایل ارسال شد!"
    end
	...
	--	post_msg(receiver, "Reloaded!", ok_cb, false)
	  send_document(get_receiver(msg), "./files/reload.webp", ok_cb, false)
		return "👾 پلاگین های ربات دوباره اجرا شدند!"
  end
 	--[[*For Debug*
